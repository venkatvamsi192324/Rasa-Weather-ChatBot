...
def run_weather_online(input_channel,interpreter,domain_file="mybotone_domain.yml",training_data_file='data/stories.md'):
...
if __name__ == '__main__':
    ...
    nlu_interpreter = RasaNLUInterpreter('./models/nlu/default/mybotone')
